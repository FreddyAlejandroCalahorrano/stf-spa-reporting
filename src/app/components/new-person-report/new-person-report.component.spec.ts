...
import { NewPersonReportComponent } from './new-person-report.component';
...
describe('NewPersonReportComponent', () => {
  let component: NewPersonReportComponent;
  let fixture: ComponentFixture<NewPersonReportComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ NewPersonReportComponent ],
      providers: [
        ProvidersService,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(NewPersonReportComponent);
  ...
  it('should get the assigned date "tentativeAsignmentEndDate"', () => {
    ...
    component.calendarSelectTentativeEndDate(data)
    fixture.detectChanges()
    expect(component.tentativeAsignmentEndDate.get('from').value).toEqual('2022-06-07')
  });
  ...
  it('should call the method "getReportPersonExcel"', () => {
    ...
    const spy = mockPersonReport.getReportPersonExcel
  ...
  it('should change the state of the variable "showMessageBarReportPerson" to false', () => {
    const event = {
      "isTrusted": false
    }
    component.onClickMessageReportPerson(event)
    expect(component.showMessageBarReportPerson).toBeFalsy()
  });
