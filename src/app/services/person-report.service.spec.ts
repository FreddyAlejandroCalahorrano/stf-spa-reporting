...
describe('PersonReportService', () => {
  let personReportService: PersonReportService;
  ...
  beforeEach(() => {
    ...
    personReportService = new PersonReportService(httpServiceMock);
  })

  it('should be created', () => {
    expect(PersonReportService).toBeTruthy();
  });
  ...
  it('should return people search', (done: DoneCallback) => {
    ...
    from(personReportService.getPersonSearchPaged(sendData.pageNo, sendData.pageSize, sendData.filters))
      .subscribe((providers) => {
  ...
  it('should return the excel file in base64', (done: DoneCallback) => {
    ...
    from(personReportService.getReportPersonExcel(sendData.filters))
      .subscribe((providers) => {
